...
class BatchCustom extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['number_recore'] = [
        ...
        '#default_value' => $config->get('number_recore'),
    ];
...
//      ->save();
    $batch = array(
      ...
      'operations' => array(
        array('disc_migrate', array('courses', array('type'=>$form_state->getValue('content_type'),'number' => $form_state->getValue('number_recore')))),
      ),
